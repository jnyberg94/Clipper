...
import rules from "../rules/defaultRules.json" with { type: 'json'};

export async function ruleEngine(allTransactions) {
  //const rules = await loadRules() //IMPORTANT for production version
...
function detectInterCorporateTransfers(allTransactions, rules) {
